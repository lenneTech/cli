...
const NewCommand: GluegunCommand = {
  ...
  run: async (toolbox: ExtendedGluegunToolbox) => {
    ...
    await system.run(`git clone https://github.com/lenneTech/chrome-extension-angular-starter.git ${projectDir}`);
    ...
    // Patch readme
    await patching.replace(`./${projectDir}/README.md`, '# Starter for Chrome Extension via Angular', `# ${name}`);
    ...
    // Set manifest.json
    await patching.update(`./${projectDir}/angular/src/manifest.json`, (config) => {
      config.name = name;
    ...
    // Patch app component
    await patching.replace(`./${projectDir}/angular/src/app/app.component.html`, 'Chrome Extension Starter', name);
    await patching.replace(`./${projectDir}/angular/src/app/app.component.html`, 'Chrome Extension starter', name);
