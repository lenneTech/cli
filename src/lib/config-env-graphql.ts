 ...
 * was written, so the key was missing entirely. That path bug is fixed on main (#106,
 * `basename()` instead of a POSIX-only suffix check); this module is the second line of
 * defence — it VERIFIES the outcome instead of trusting that some step produced it.
 *
